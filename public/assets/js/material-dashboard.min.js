...
function navbarColorOnResize() {
    ...
    // Jika lebar jendela lebih besar dari 1200px
    if (windowWidth >= 1200) {
        // Periksa apakah referenceButtons memiliki kelas "active" dan "bg-transparent"

            // Jika tidak, tambahkan kelas "bg-white" ke sidenav
            sidenav.classList.add("bg-white");

    } else {
        // Jika lebar jendela kurang dari 1200px, tambahkan kelas "bg-white" dan hilangkan kelas "bg-transparent" dari sidenav
        sidenav.classList.add("bg-white");
        sidenav.classList.remove("bg-transparent");
    }
}
