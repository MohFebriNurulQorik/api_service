  ...
  AdvancedForm.prototype.init = function() {
    ...
    $(function() {
        ...
        function cb(start, end) {
            $('input[name="mydaterange"]').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        }
        ...
        $('input[name="mydaterange"]').daterangepicker({
            ...
            ranges: {
                'Today': [moment(), moment()],
                'Prev Day': [moment().subtract(1, 'days'), moment().subtract(1, 'days')],
                ...
                'Prev Year': [moment().subtract(1, 'year').startOf('year'), moment().subtract(1, 'year').endOf('year')]
            }
        }, cb);
